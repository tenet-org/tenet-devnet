...
To run devnet validator nodes, you will need a machine with the following minimum hardware requirements:
...
```bash
git clone https://github.com/tenet-org/tenet-devnet.git ~/.tenetd
```
...
To create your validator on devnet, just use the following command:
